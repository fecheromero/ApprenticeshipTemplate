...
describe 'Tennis team1 vs team2 in a set' do
  ...
  context '' do
    ...
    it 'make a team win a set 6-4 (raise exception win)' do
...
describe 'make a invalid team win a point in a game' do
  let(:team1){TennisTeam.new('team1') }
  let(:team2){TennisTeam.new('team2')}
  let(:game){TennisGame.new(team1,team2)}
  it 'raise error' do
    expect{game.teamWinPoint (TennisTeam.new('invalid team'))}.to raise_exception('invalid team')
  end
end